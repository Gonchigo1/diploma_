package mn.astvision.starter.s3.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import mn.astvision.starter.dto.MoveFileRequest;
import mn.astvision.starter.exception.AwsException;
import mn.astvision.starter.exception.ContentTypeException;
import mn.astvision.starter.s3.properties.AwsS3Properties;
import mn.astvision.starter.s3.ImageType;
import mn.astvision.starter.service.ImageService;
import mn.astvision.starter.s3.util.ImageTypeResolver;
...
public class S3BucketService {
    ...
    public String uploadStream(
        ...
        try (stream) {
            ...
            log.info("{} -> file uploaded with etag: {}", fileKey, putResponse.eTag());
