...
//import mn.astvision.starter.exception.InjectUserException;
...
//
//    @Around("@annotation(mn.astvision.starter.annotations.InjectUser)")
...
//
//        mn.astvision.starter.model.auth.User user = userRepository.findByEmail(userDetails.getUsername());
//        if (user == null)
...
//                if (arg instanceof mn.astvision.starter.model.auth.User)
//                    newArgs.add(user);
//                else
//                    newArgs.add(arg);
//            }
