...
public class LoggerAspect {
    ...
    @Before("@annotation(mn.astvision.starter.util.logger.LogExecutionDuration)")
    ...
    @After("@annotation(mn.astvision.starter.util.logger.LogExecutionDuration)")
    ...
    @Around("@annotation(mn.astvision.starter.util.logger.LogExecutionDuration)")
