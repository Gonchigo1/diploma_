...
public class FirebaseMessagingService {
    private Message.Builder buildMessage(String registrationToken, PushNotificationType type, String title,
    ...
    private MulticastMessage.Builder buildMultiCastMessage(Collection<String> registrationTokens,
            PushNotificationType type, String title, String body, Map<String, String> data) {
    ...
    public String send(
        ...
        setAndroidConfig(builder, AndroidNotification.Priority.DEFAULT, AndroidNotification.Visibility.PUBLIC,
                title, body);
    ...
    public String checkToken(String registrationToken) throws FirebaseMessagingException {
        Message.Builder builder = buildMessage(registrationToken, PushNotificationType.DEFAULT, "<title>",
                "<body", null);
        setAndroidConfig(builder, AndroidNotification.Priority.DEFAULT, AndroidNotification.Visibility.PUBLIC,
                "<title>", "<body");
        setApnsConfig(builder);
    ...
    public BatchResponse checkTokenMulti(Collection<String> registrationTokens) throws FirebaseMessagingException {
        MulticastMessage.Builder builder = buildMultiCastMessage(registrationTokens,
                PushNotificationType.DEFAULT, "<title>", "<body", null);
        setAndroidConfig(builder, AndroidNotification.Priority.DEFAULT, AndroidNotification.Visibility.PUBLIC,
                "<title>", "<body");
        setApnsConfig(builder);
